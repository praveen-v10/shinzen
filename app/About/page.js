...
function page() {
  return (
    <div>
      ...
      <div className="bg-[#E3F4F5] w-full">
        ...
        <div className="bg-[#E3F4F5] w-full pb-20">
          <div className="max-w-[85%] mx-auto ">
            ...
            <div className="flex justify-center">
              <div className="w-[50%]">
                <p className="text-[1vw] font-T2 font-medium text-center text-gray-600">
                  We&apos;re just getting started, but our vision and passion are
                  driving us toward greatness. Explore the milestones that have
                  already defined our path.
                </p>
              </div>
            </div>

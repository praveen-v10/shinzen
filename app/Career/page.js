...
function page() {
  ...
  <div className="pt-10">
  <h2 className="font-T1 font-semibold text-center  text-[#008080] text-[1.5vw] tracking-wide">Your Seat is reserved</h2>
  <p className="font-T2 font-semibold text-black text-center text-[2vw] tracking-wide">Join our team soon!</p>
  </div>
...
<Footer/>
  ...
  <div className="pt-10">
  <h2 className="font-T1 font-semibold text-center  text-[#008080] text-[5vw] tracking-wide">Your Seat is reserved</h2>
  <p className="font-T2 font-semibold text-black text-center text-[6vw] tracking-wide">Join our team soon!</p>
  </div>

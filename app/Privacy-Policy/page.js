    ...
    <div>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc ml-6 text-gray-600 font-T2">
          ...
          <li><strong>Usage Information:</strong> Information related to your interaction with our website, such as IP address, browser type, and pages visited, is collected for analytical purposes.</li>

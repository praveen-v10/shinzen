  ...
  return (
    <div>
      ...
      <div className="hidden  2xl:block ">
        <div className=" bg-[url('https://firebasestorage.googleapis.com/v0/b/zenth-web.appspot.com/o/service%20bg%201.png?alt=media&token=3295c06d-c1e6-4e1c-a4bd-8e1974a02d06')] bg-cover bg-center">
          <div className="max-w-[85%] mx-auto">
            <div id='software' className="flex justify-center items-center pt-28">
              <Image
        ...
        <div id='web' className=" bg-[url('https://firebasestorage.googleapis.com/v0/b/zenth-web.appspot.com/o/service%20bg%202.png?alt=media&token=75d22550-3334-457f-881b-64a4f1d494c1')] bg-cover bg-center">
          <div className="max-w-[85%] mx-auto">
        ...
        <div className=" bg-[url('https://firebasestorage.googleapis.com/v0/b/zenth-web.appspot.com/o/service%20bg%204.png?alt=media&token=a8d2d9a0-6d9c-4cc9-90c4-5c105629fd75')] bg-cover bg-center">
          <div className="max-w-[85%] mx-auto">
            <div id='marketing' className="flex justify-center items-center pt-20">
              <Image
        ...
        <div className=" bg-[url('https://firebasestorage.googleapis.com/v0/b/zenth-web.appspot.com/o/service%20bg%206.png?alt=media&token=46d0c16b-ed15-4d73-b79d-5485e1530f60')] bg-cover bg-center">
          <div className="max-w-[85%] mx-auto">
            ...
            <div className="flex justify-center">
              <p className="text-[1vw] font-T2 font-medium text-gray-600 text-center">
                Capture your brand&apos;s essence with professional photography and
                <br />
      ...
      <div className="hidden 2xl:hidden lg:block">
        <div className=" bg-[url('https://firebasestorage.googleapis.com/v0/b/zenth-web.appspot.com/o/service%20bg%201.png?alt=media&token=3295c06d-c1e6-4e1c-a4bd-8e1974a02d06')] bg-cover bg-center">
          <div className="max-w-[85%] mx-auto">
            <div id='lapsoftware' className="flex justify-center items-center pt-28">
              <Image
                src="https://firebasestorage.googleapis.com/v0/b/zenth-web.appspot.com/o/service%201.png?alt=media&token=83f66f03-98b1-4717-a633-12d974eb64e0"
                alt="Home About"
                width={0}
        ...
        <div className=" bg-[url('https://firebasestorage.googleapis.com/v0/b/zenth-web.appspot.com/o/service%20bg%204.png?alt=media&token=a8d2d9a0-6d9c-4cc9-90c4-5c105629fd75')] bg-cover bg-center">
          <div className="max-w-[85%] mx-auto">
            <div id='lapmarketing' className="flex justify-center items-center pt-20">
              <Image
                src="https://firebasestorage.googleapis.com/v0/b/zenth-web.appspot.com/o/service%204.png?alt=media&token=f213aed1-dc34-41ec-a198-efc2d6ba42d5"
                alt="Service"
                width={0}
        ...
        <div className=" bg-[url('https://firebasestorage.googleapis.com/v0/b/zenth-web.appspot.com/o/service%20bg%205.png?alt=media&token=94a3bb7b-9284-4163-b055-3c7be894a67b')] bg-cover bg-center">
          <div className="max-w-[85%] mx-auto">
            <div id='lapui/ux' className="flex justify-center items-center pt-20">
              <Image
                src="https://firebasestorage.googleapis.com/v0/b/zenth-web.appspot.com/o/service%205.png?alt=media&token=eb44bddc-1830-49cc-b490-27e01aac6140"
                alt="Service"
                width={0}
        ...
        <div className=" bg-[url('https://firebasestorage.googleapis.com/v0/b/zenth-web.appspot.com/o/service%20bg%206.png?alt=media&token=46d0c16b-ed15-4d73-b79d-5485e1530f60')] bg-cover bg-center">
          <div className="max-w-[85%] mx-auto">
            <div id='lapvisual' className="flex justify-center items-center pt-20">
              <Image
                src="https://firebasestorage.googleapis.com/v0/b/zenth-web.appspot.com/o/service%206.png?alt=media&token=5b4e807f-5a97-454e-b4e3-6e3d8030e2cc"
                alt="Service"
                width={0}

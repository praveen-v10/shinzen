        ...
        <div className="max-w-[85%] mx-auto pt-[20vh]">
          <div className="flex justify-evenly">
            ...
            <div className="w-[45%] ">
              ...
              <div className=''>
  <p className='text-[1.2vw] font-T2 font-medium text-black'>Innovative digital solution experts.</p>
</div>
        ...
        <div className="max-w-[90%] mx-auto">
          <div className=" pt-10">
            <div>
              ...
              <div className='flex justify-center'>
  <p className='text-[4vw] font-T2 font-medium text-black'>Innovative digital solution experts.</p>
</div>

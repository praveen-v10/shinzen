...
function Review() {
  return (
    ...
    <div className="flex justify-center space-x-4">
            <h1 className="text-[3vw] font-T1 font-bold text-[#008080]">Words</h1>
            <h1 className="text-[3vw] font-T1 font-bold text-gray-500">
            of
            </h1>
            <h1 className="text-[3vw] font-T1 font-bold text-[#008080]">Praise</h1>
          </div>
...
<div className='flex justify-center space-x-4'>
  ...
  <h1 className='text-[8vw] font-T1 font-bold text-[#008080]'>Words</h1>
  <h1 className='text-[8vw] font-T1 font-bold text-gray-500'>of</h1>
  <h1 className='text-[8vw] font-T1 font-bold text-[#008080]'>Praise</h1>
</div>
<div className='flex justify-center'>
  <p className='text-[4vw] font-T2 font-medium text-black'>Transforming Visions into Reality</p>
</div>
